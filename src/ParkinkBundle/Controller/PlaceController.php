...
//use ParkinkBundle\Form\PlaceType;
...
class PlaceController extends Controller
{
    ...
    {
        $place = new Place();
        $form = $this->createForm('ParkinkBundle\Form\PlaceType', $place);
        $form->handleRequest($request);

        if ($form->isSubmitted() && $form->isValid()) {
            //$place->getImage()->upload();
            $em = $this->getDoctrine()->getManager();
            $em->persist($place);
            $em->flush();
    ...
    {
        $deleteForm = $this->createDeleteForm($place);
        $editForm = $this->createForm('ParkinkBundle\Form\PlaceType', $place);
